...
\shorttitle{The role of the forcing scale in $\beta$-plane turbulence}
\shortauthor{J. Chai and M. F. Jansen}
...
%($\delta k_f$, decorrelation time scale, etc.)
...
of the $Z=1.4$ runs. %Anisotropy of the flow 
...
%It is likely that within $k_{\varepsilon}\apprle k\apprle70$,
...
downscale enstrophy transfer in the regime $\Pi\apprle 1$.
...
mechanism discussed by \citet{Manz2009}. In this picture,
...
picture is that the $\beta$-effect is playing the fundamental role in 
directing the energy cascade into the jets, as mentioned in the
introduction, while the shear further weakens the already 
...
%even sharper when $\Pi$ reduces to below 1. 
The PV staircase 
