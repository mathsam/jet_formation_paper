...
is conveniently characterized by an additional nondimensional number 
$\Pi$, which is the ratio of crossover scale to forcing scale.
When $\Pi<1$, a new form of crossover scale is proposed and is related 
to the classical crossover scale by a factor of $\Pi^{2/3}$, which indicates
...
with numerical simulations. When $1.5\apprle Z\apprle2.5$, both $Z$ and
$\Pi$ influence jet formation: jets are stronger and more coherent
for larger $Z$ or smaller $\Pi$. When $Z\apprge2.5$, the flow is
