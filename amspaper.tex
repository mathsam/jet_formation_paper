...
\begin{equation}
    \mathcal{E}(k)=\mathcal{C_{K}'}\eta^{2/3}k^{-3},\label{eq:Kolmogorov_Kraichnan_spectrum_enstrophy}
\end{equation}
where $\mathcal{C}_{\mathcal{K}'}$ is $1.3\sim1.6$ \citep{Maltrud1991,Smith1993,Paret1997,Chen2006,Borue1993,Gotoh1998}.
...
the scale where energy gets channeled into jets \citet{Williams1978,Jansen2012,Chai2014,Liu2015,Chemke2015}.
